...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="jumbotron">
        <div class="title bg-warning">Clerk Dashboard</div>
    ...
    <div class="container row d-inline" style="align-items: center; margin: auto;">
        <a href="fillExpenditure.php?id='<?php echo $_GET["id"];?>'"><div class="col-sm-12 col-md-12 user bg-success">Fill Expenditure</div></a>
