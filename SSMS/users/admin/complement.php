...
<head>
    ...
    <title>Complementary Seats Distribution</title>
...
<body>
<div class="jumbotron">
    <div class="title">Complementary Seats Distribution</div>
</div>
<div class="container" width="30%" style="padding:150px;border:3px inherit green">
    <form action="bookTicketComp.php" method="post" enctype="multipart/form-data">
