...
<body>
<div class="jumbotron">
    <div class="title">Print Ticket</div>
</div>
<div class="container" width="30%" style="padding:150px;border:3px inherit green">
    <form action="printTicketProcess.php" method="post" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" name = "getTicket">Get Ticket</button>
    </form>
</div>
</body>
