...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="jumbotron">
        <div class="title bg-warning">Sales Person Dashboard</div>
    ...
    <div class="container row d-inline" style="align-items: center; margin: auto;">
        <a href="bookTicket.php?id='<?php echo $_GET["id"];?>'"><div class="col-sm-12 col-md-12 user bg-success">Book Ticket</div></a>
